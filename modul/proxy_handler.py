...
# Fungsi untuk menormalkan proxy agar selalu memiliki prefix http://
...
# Fungsi untuk memuat ulang daftar proxy dan menambahkan http:// jika belum ada
async def reload_proxy_list(proxy_file):
    with open(proxy_file, 'r') as file:
        local_proxies = file.read().splitlines()
    local_proxies = normalize_proxies(local_proxies)
...
async def main(proxy_file, user_id):
    ...
    with open(proxy_file, 'r') as file:
        local_proxies = file.read().splitlines()
    local_proxies = normalize_proxies(local_proxies)  # Normalisasi proxy pertama kali
